...
console.log('12) combining array using concat method:', names1.concat(names2, names3));
...
// using fill
console.log('15) replacing last element with first using fill method:', array1.fill(array1[0], array1.length - 1));
// using copyWithin
console.log('15) replacing last element with first using copyWithin method:', array1.copyWithin(array1.length - 1));
// using splice
array1.splice(array1.length - 1, 1, array1[0]);
console.log('15) replacing last element with first using splice method:', array1);
